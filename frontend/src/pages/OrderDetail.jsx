...
const OrderDetail = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      let response1 = await axios.post(api1, {
        cusid: localStorage.getItem("cusid"),
      });
        ...
        <div className="order-detail-container">
          ...
          <div className="order-info-section">
            ...
            <p>
              ...
              {new Date(orderdetail.orderAt).toLocaleDateString()}
            </p>
            <p>
              <strong>Status:</strong>{" "}
              <span className="status shipped">Order Placed</span>
            </p>
          ...
          <div className="info-sections">
            <div className="shipping-info">
              ...
              <p>
                <strong>Phone:</strong> {customerdetail.number}
              </p>
              <p>
                <strong>Address:</strong> {customerdetail.address}
              </p>
              <p>
                <strong>City:</strong> {customerdetail.city}
              </p>
              <p>
                <strong>State:</strong> {customerdetail.state}
              </p>
            </div>
            ...
            <div className="payment-info">
              ...
              <p>
                <strong>Method:</strong> {orderdetail.ordermethod}
              </p>
              <p>
                <strong>Status:</strong>{" "}
                <span className="status paid">{orderdetail.paymentstatus}</span>
              </p>
            </div>
          </div>
        </div>
