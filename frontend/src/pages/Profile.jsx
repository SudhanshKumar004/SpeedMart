  ...
  return (
    ...
    <div className="Profile-container">
        ...
        <div className="customerImage">
            <img src={customerData.customerImage ? `${API_URL}/${customerData.customerImage}` : "https://cdn-icons-png.flaticon.com/512/149/149071.png"} 
            alt="Customer" 
            />
        <input  type="file"  id="imageUpload"  style={{ display: "none" }}  onChange={(e) => setImage(e.target.files)}/>
        <button  type="button"  className="edit-icon"  onClick={() => document.getElementById("imageUpload").click()}> ✏️ </button>
        <button type='button' className='delete-icon' onClick={ImageDelete}> X </button>
</div>
   ...
   <Form className="profile-form" onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="sm-1" controlId="formBasicState">
                        ...
                        <Form.Select name="state" value={customerData.state || ''} onChange={handleInput}>
